...
public class SignInSteps {
	...
	@When("user enters <First name> and Lastname1 and {int} and name@gmail.com and Rue de la bource and Tunis and Tunis and {int} and Tunisia and User1 and qwerty.{int} and qwerty.{int}")
	public void user_enters_first_name_and_lastname1_and_and_name_gmail_com_and_rue_de_la_bource_and_tunis_and_tunis_and_and_tunisia_and_user1_and_qwerty_and_qwerty(Integer int1, Integer int2, Integer int3, Integer int4) {
